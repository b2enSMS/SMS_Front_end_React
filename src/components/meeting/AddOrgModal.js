...
const AddOrgModal = ({custList, visible, HandleCancel, handleChangeInput, custModal, handleOk}) => {
    ...
    const autoCompleteHandleChange = (ev, value) => {
        ...
        for (var key in value) {
            handleChangeInput({ form: "custModal", key: key, value: value[key] });
        }
    }
        ...
        >
            <Container component="main" maxWidth="xs">
                <form className={classes.form} noValidate>
                        ...
                        inputValue={custModal.custNm}
                        value={{ custNm: custModal.custNm }}
